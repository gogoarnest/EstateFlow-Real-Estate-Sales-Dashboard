...
CREATE TABLE `users` (
  ...
  `role` enum('admin','leader','senior','sales') DEFAULT 'sales',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'George', 'admin@estateflow.com', '123456', 'admin', '2026-03-10 20:35:06'),
(2, 'Fady', 'Fady@estateflow.com', '12345', 'sales', '2026-03-11 13:12:06');
